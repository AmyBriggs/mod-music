app.controller('BuildController', ['$scope','$rootScope', '$cookies', 'BuildService', '$window', function($scope, $rootScope, $cookies, BuildService, $window) {
 ...
 let sounds = {
  ...
  elBass: {
   ...
   Cs: new Howl({
    urls: ['sounds/bass/electric_bass_pick-mp3/Db2.wav'],
   }),
   D: new Howl({
    urls: ['sounds/bass/electric_bass_pick-mp3/D2.wav'],
   }),
   Eb: new Howl({
    urls: ['sounds/bass/electric_bass_pick-mp3/Eb2.wav'],
   }),
   E: new Howl({
    urls: ['sounds/bass/electric_bass_pick-mp3/E2.wav'],
   }),
   F: new Howl({
    urls: ['sounds/bass/electric_bass_pick-mp3/F2.wav'],
   }),
   Fs: new Howl({
    urls: ['sounds/bass/electric_bass_pick-mp3/Gb2.wav'],
   }),
   G: new Howl({
    urls: ['sounds/bass/electric_bass_pick-mp3/G2.wav'],
   }),
   Ab: new Howl({
    urls: ['sounds/bass/electric_bass_pick-mp3/Ab2.wav'],
   }),
   A: new Howl({
    urls: ['sounds/bass/electric_bass_pick-mp3/A2.wav'],
   }),
   Bb: new Howl({
    urls: ['sounds/bass/electric_bass_pick-mp3/Bb2.wav'],
   }),
   B: new Howl({
    urls: ['sounds/bass/electric_bass_pick-mp3/B2.wav'],
  }),
  C1: new Howl({
   urls: ['sounds/bass/electric_bass_pick-mp3/C3.wav'],
 }),
  Cs1: new Howl({
   urls: ['sounds/bass/electric_bass_pick-mp3/Db3.wav'],
 }),
  D1: new Howl({
   urls: ['sounds/bass/electric_bass_pick-mp3/D3.wav'],
 }),
  Eb1: new Howl({
   urls: ['sounds/bass/electric_bass_pick-mp3/Eb3.wav'],
 }),
  E1: new Howl({
   urls: ['sounds/bass/electric_bass_pick-mp3/E3.wav'],
 }),
  F1: new Howl({
   urls: ['sounds/bass/electric_bass_pick-mp3/F3.wav'],
 }),
  Fs1: new Howl({
   urls: ['sounds/bass/electric_bass_pick-mp3/Gb3.wav'],
 }),
  G1: new Howl({
   urls: ['sounds/bass/electric_bass_pick-mp3/G3.wav']
 })
  },
  drums: {
    606: {
